...
const NAME_MAPPING = {
    ...
    D0310D: {name: 'fanSpeed', options: {'s': 'silent', 't': 'turbo', 'a': 'auto', '1': '1', '2': '2', '3': '3'}, control: true},
    D03125: {name: 'humidity'},
    D03120: {name: 'allergenIndex'},
    D03224: {name: 'temperature'},
        ...
        return new Promise((resolve, reject) => {
            ...
            this._statusRequest.on('response', res => {
                ...
                res.on('data', chunk => {
                    ...
                    this.decryptPayload(chunk).then(status => {
